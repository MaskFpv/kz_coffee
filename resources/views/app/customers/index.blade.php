                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 text-right">
                            <button type="button" id="export-pdf-btn" class="btn btn-danger">
                                <a href="{{ route('customer-exportPdf') }}" style="text-decoration: none; color:azure;"><i
                                        class="bi bi-file-earmark-pdf"></i>
                                    Export PDF</a>
                            </button>
                            <button type="button" id="export-pdf-btn" class="btn btn-success">
                                <a href="{{ route('customer-export') }}" style="text-decoration: none; color:azure;"><i
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form action="{{ route('customer-import') }}" method="post" enctype="multipart/form-data">
                        ...
                        <p>Tidak punya format nya? <a href="{{ asset('import/import-customer.xlsx') }}"
                                download="">Download
                                Import
                                Excel</a></p>
